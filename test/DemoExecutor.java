...
public class DemoExecutor 
{
    public static void main(String[] args) 
    {
        ...
        BlockingQueue<Runnable> blockingQueue = new ArrayBlockingQueue<Runnable>(19);
    ...
    public static class CustomThreadPoolExecutor extends ThreadPoolExecutor {
        ...
        protected void beforeExecute(Thread t, Runnable r) {
            ...
            System.out.println("Perform beforeExecute() logic of runnable "+((DemoThread)r).getName());
        }
        ...
        protected void afterExecute(Runnable r, Throwable t) {
            ...
            System.out.println("Perform afterExecute() logic of runnable "+((DemoThread)r).getName());
        }
